        ...
        <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="600" style="max-width:600px;background:#FFFFFF;border-radius:14px;overflow:hidden;box-shadow:0 4px 24px rgba(31,26,20,.06)">
          ...
          <tr>
            <td style="background:linear-gradient(135deg,#1F1A14 0%,#2A2218 100%);padding:48px 32px;text-align:center">
              <div style="display:inline-block;padding:14px 22px;border:1px solid rgba(201,169,110,.4);border-radius:4px">
                <div style="font-family:Georgia,'Times New Roman',serif;font-size:11px;letter-spacing:.45em;color:#C9A96E;text-transform:uppercase">6ixstars</div>
                <div style="font-family:Georgia,'Times New Roman',serif;font-size:9px;letter-spacing:.32em;color:rgba(212,182,138,.6);text-transform:uppercase;margin-top:3px">Ropa urbana</div>
              </div>
            </td>
          </tr>
          ...
          <tr>
            <td style="background:#1F1A14;padding:36px 48px;text-align:center">
              <div style="font-family:Georgia,'Times New Roman',serif;font-size:12px;letter-spacing:.42em;color:#C9A96E;text-transform:uppercase;margin-bottom:14px">6ixstars</div>
    ...
    <tr><td align="center">
      <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="600" style="max-width:600px;background:#FFFFFF;border-radius:14px;overflow:hidden;box-shadow:0 4px 24px rgba(31,26,20,.06)">
        ...
        <tr>
          <td style="background:linear-gradient(135deg,#1F1A14 0%,#2A2218 100%);padding:48px 32px;text-align:center">
            <div style="display:inline-block;padding:14px 22px;border:1px solid rgba(201,169,110,.4);border-radius:4px">
              <div style="font-family:Georgia,serif;font-size:11px;letter-spacing:.45em;color:#C9A96E;text-transform:uppercase">6ixstars</div>
              <div style="font-family:Georgia,serif;font-size:9px;letter-spacing:.32em;color:rgba(212,182,138,.6);text-transform:uppercase;margin-top:3px">Ropa Urbana</div>
            </div>
          </td>
        </tr>
        ...
        <tr>
          <td style="background:#1F1A14;padding:36px 48px;text-align:center">
            <div style="font-family:Georgia,serif;font-size:12px;letter-spacing:.42em;color:#C9A96E;text-transform:uppercase;margin-bottom:14px">6ixstars</div>
            <div style="font-size:11px;color:rgba(250,246,238,.55);line-height:1.7;letter-spacing:.04em">
              Ropa urbana · Colombia<br/>
              <a href="https://6ixstars.com.co" style="color:rgba(250,246,238,.7);text-decoration:none">6ixstars.com.co</a>
            </div>
