...
export const collections = [
  { id: 'bermudas',  slug: 'bermudas',  name: 'Bermudas',  description: 'Frescas para el calor de la calle', color: '#2E86C1', image: '/img/placeholder.webp' },
  { id: 'conjuntos', slug: 'conjuntos', name: 'Conjuntos', description: 'Sets completos, fit armado',         color: '#E84393', image: '/img/placeholder.webp' },
  { id: 'camisas',   slug: 'camisas',   name: 'Camisas',   description: 'Oversize, manga corta y larga',      color: '#00B894', image: '/img/placeholder.webp' },
  { id: 'buzos',     slug: 'buzos',     name: 'Buzos',     description: 'Hoodies y crewnecks pesados',         color: '#E17055', image: '/img/placeholder.webp' },
  { id: 'jeans',     slug: 'jeans',     name: 'Jeans',     description: 'Baggy, recto y cargo denim',          color: '#4A69BB', image: '/img/placeholder.webp' },
  { id: 'gorras',    slug: 'gorras',    name: 'Gorras',    description: 'Snapback, trucker y dad hats',        color: '#F2A015', image: '/img/placeholder.webp' },
];
