      ...
      <div className="container" style={{ padding: '56px 24px', maxWidth: '800px' }}>
        ...
        <div style={{ marginBottom: 56 }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: 24 }}>
            {steps.map(s => (
              <div key={s.n} style={{ padding: '24px', background: 'var(--dark-2)', borderTop: '2px solid var(--gold)' }}>
        ...
        {/* CTA contacto */}
        <div style={{ padding: '32px', background: 'var(--dark-2)', borderLeft: '3px solid var(--gold)', marginTop: 40 }}>
